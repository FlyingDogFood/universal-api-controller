...
//+kubebuilder:rbac:groups=universal-api-controller.io.universal-api-controller.io,resources=configs,verbs=get;
//+kubebuilder:rbac:groups=universal-api-controller.io.universal-api-controller.io,resources=configs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=universal-api-controller.io.universal-api-controller.io,resources=configs/finalizers,verbs=update
//+kubebuilder:rbac:groups=universal-api-controller.io.universal-api-controller.io,resources=configTemplates,verbs=get;
//+kubebuilder:rbac:groups=universal-api-controller.io.universal-api-controller.io,resources=functions,verbs=get;
//+kubebuilder:rbac:groups=universal-api-controller.io.universal-api-controller.io,resources=endpointTemplates,verbs=get;
